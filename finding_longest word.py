...
def finding_longest_word(text):
    ...
    for word in word_list:
        ...
        # processed_word = word using word with punctuations
        ...
        if len(processed_word)>longest_word_length:
            longest_word = [processed_word]
            longest_word_length = len(processed_word)

        elif len(processed_word) == longest_word_length:
            longest_word.append(processed_word)

    return longest_word,longest_word_length

        
print(finding_longest_word(text))
        



print(text.find("never-before-known"))