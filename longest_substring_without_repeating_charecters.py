...
string = """ I stared at the crowd and told the biggest lie of my life.
...
def longest_substring(string):
    splitted_string = string.split() # This will split tehe string along any number of spaces use this instead of split(" ")
